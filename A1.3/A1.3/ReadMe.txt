========================================================================
    KONSOLENANWENDUNG: A1.3-Projektübersicht
========================================================================

Diese A1.3-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre A1.3-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen A1.3.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
