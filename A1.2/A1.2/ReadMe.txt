========================================================================
    KONSOLENANWENDUNG: A1.2-Projektübersicht
========================================================================

Diese A1.2-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre A1.2-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen A1.2.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
